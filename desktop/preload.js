...
contextBridge.exposeInMainWorld('worldstageClient', {
  ...
  authenticateAccount: (payload) => ipcRenderer.invoke('client:authenticate-account', payload),
  ...
  openWorldStage: (payload) => ipcRenderer.invoke('client:open-worldstage', payload),
