...
class WorldStageAppUpdater {
  constructor(options = {}) {
    ...
    this.arch = normalizeText(options.arch) || process.arch;
  ...
  buildInitialState(options = {}) {
    ...
    const linuxArm64UpdateFeedUnavailable = this.platform === 'linux' && this.arch === 'arm64';
    ...
    else if (linuxArm64UpdateFeedUnavailable) disabledReason = 'linux_arm64_update_feed_unavailable';
    return {
